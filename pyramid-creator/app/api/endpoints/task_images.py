...
from app.schemas.task_image import CreateTaskImage, TaskImage
...
def create_task_image(*, collection: Collection = Depends(get_task_image_collection),
                      name: str = Form(...), image: UploadFile = File(...)) -> TaskImage:
    ...
    try:
        ...
        return crud_task_image.get_by_objectId(collection=collection, object_id=task_image_object_id)
