...
export const floppydisk: Icon = {
  style: 'line',
  name: 'floppy-disk',
  path: '<path d="M216,91.31371V208a8,8,0,0,1-8,8H48a8,8,0,0,1-8-8V48a8,8,0,0,1,8-8H164.68629a8,8,0,0,1,5.65686,2.34315l43.3137,43.3137A8,8,0,0,1,216,91.31371Z" fill="none" stroke="current" stroke-linecap="round" stroke-linejoin="round" ></path><path d="M80,216.00842v-64a8,8,0,0,1,8-8h80a8,8,0,0,1,8,8v64" fill="none" stroke="current" stroke-linecap="round" stroke-linejoin="round" ></path><line x1="152" y1="72.00903" x2="96" y2="72.00903" fill="none" stroke="current" stroke-linecap="round" stroke-linejoin="round" ></line>'
};
...
export const pininfo: Icon = {
  style: 'line',
  name: 'pin-info',
  path: '    <line x1="128" y1="210" x2="128" y2="240" fill="none" stroke="current" stroke-linecap="round" stroke-linejoin="round" ></line>    <line x1="64" y1="40" x2="192" y2="40" fill="none" stroke="current" stroke-linecap="round" stroke-linejoin="round" ></line>    <line x1="40" y1="210" x2="216" y2="210" fill="none" stroke="current" stroke-linecap="round" stroke-linejoin="round" ></line>    <line x1="56" y1="210" x2="80" y2="40" fill="none" stroke="current" stroke-linecap="round" stroke-linejoin="round" ></line>    <line x1="176" y1="40" x2="200" y2="210" fill="none" stroke="current" stroke-linecap="round" stroke-linejoin="round" ></line>    <polyline points="120 120 128 120 128 176 136 176" fill="none" stroke="current" stroke-linecap="round" stroke-linejoin="round" >    </polyline>    <circle cx="126" cy="84" r="6" fill="current" stroke="current">    </circle>'
};
