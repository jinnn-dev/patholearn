...
def upgrade():
    ...
    op.drop_constraint(
        "questionnaireanswer_ibfk_1", "questionnaireanswer", type_="foreignkey"
    )
    op.create_foreign_key(
        None, "questionnaireanswer", "questionnairequestion", ["question_id"], ["id"]
    )
    op.alter_column(
